...
- **Rapport généré**: `sample_000160_whisper_spacy_result.md`
...
```bash
python3 -m src.cli.pipeline --audio data/raw/audio/sample_000160.wav --stt-model whisper --nlp-model spacy
```
